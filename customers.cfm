						...
						<div class="header-navigation">
							<nav class="header-menu">
									<ul>
                                       ...
                                       <li>
											<a href="members.cfm">Customers</a>
										</li>
                    <li>
								...
								<div class="page-title-bottom-inner2">
									...
									<div class="page-title-breadcrumbs">
										<ul>
											...
											<li><a href="newCustomer.cfm">New Customer</a></li>
...
<cfoutput>
						...
						<div class="row">
                                ...
                                select [code],[customerName],[address],[customerPhone],[customerEmail],[status],[creator],[OpeningBalance],[dateUpdated],[openDate],[gender],[accountOfficer],customerId
                                from customers
                                order by customerID
                                </cfquery>
                                ...
                                <table>
                                <tr>
                                	<td><strong>No.</strong></td><td><strong>Account No.</strong></td><td><strong>Names</strong></td><td><strong>Officer</strong></td><td><strong>Phone</strong></td><td><strong>Reg. Date</strong></td><td><strong>Status</strong></td><td><strong>Action</strong></td>
                                </tr>
                                <cfloop query="members">
                                <tr id="member">
                                	<td>#members.CurrentRow#</td><td>#code#</td><td>#customerName#</td><td>#Ucase(accountOfficer)#</td><td>#customerPhone#</td><td>#dateformat(openDate,"dd/mm/yyyy")#</td><td>#status#</td><td><a href="customersLedger.cfm?id=#customerId#"><font color="red">More details</font></a></td>
                                </tr>
                                </cfloop>
                                </table>
