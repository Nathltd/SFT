		...
		<div id="wrapper">
			...
			<div id="core">
				...
				<div class="container">
					...
					<div id="page-content">
<cfoutput>
						<h2>#session.auth.lastname# #session.auth.firstname# [#session.auth.Designation#]</h2>
						...
						<!-- CONTACT FORM : begin -->
							...
							<div class="row">
								...
								<div class="resultCol">
									...
									<hr>
                                    <h3><strong>Income Statement Summary</strong></h3>
 										
									<hr>
                                    <div class="form-field">
                                    <cfquery name="payments">
                                    select sum(amount) As total
                                    from vwInitialPayments
                                    </cfquery>
										<span class="myPortal">All Time Income: </span>
                  ...
                  <hr>
                                    ...
                                    where datepart(qq, paymentdate) = datepart(qq, getdate())
										...
										<span class="myPortal">Total Income (Quarter-To-Date): </span>
                                    ...
                                    WHERE Month(PaymentDate) = #month(now())#
										...
										<span class="myPortal">Total Income (Month-To-Date): </span>
                                    ...
                                    where datepart(ww, paymentdate) = datepart(ww, getdate())
										...
										<span class="myPortal">Total Income (Week-To-Date):</span>
                                    ...
                                    where datepart(dd, paymentdate) = datepart(dd, getdate())
										...
										<span class="myPortal">Total Income (Today):</span>
