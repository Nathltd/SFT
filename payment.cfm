			...
			<div id="core">
								...
								<div class="page-title-bottom-inner2">
									...
									<div class="page-title-breadcrumbs">
										<ul>
											...
											<li><a href="payment.cfm">New Deposit</a></li>
											<li><a href="customersLedger.cfm">Customer Ledger</a></li>
										</ul>
									</div>
				...
				<div class="container">
                 ...
                 <cfoutput>
                    ...
                    <cfquery>
							INSERT INTO payments (PaymentID,paymentDate,customerID,Type,Amount,staffId,payDetails,LastUpdated,Creator)
							VALUES (<cfqueryparam value="#form.paymentId#" cfsqltype="cf_sql_char">, <cfqueryparam value="#lsDateFormat(CreateODBCDate(form.paydate), "dd/mm/yyyy")#" cfsqltype="cf_sql_date">,<cfqueryparam value="#trim(form.customerId)#" cfsqltype="cf_sql_char">,<cfqueryparam value="#form.payType#" cfsqltype="cf_sql_char">, <cfqueryparam value="#trim(form.amount)#" cfsqltype="cf_sql_double">,<cfqueryparam value="#form.accountofficer#" cfsqltype="cf_sql_char">,<cfqueryparam value="#form.paydetails#" cfsqltype="cf_sql_char">,<cfqueryparam value="#lsDateFormat(CreateODBCDate(Now()), "dd/mm/yyyy")#" cfsqltype="cf_sql_date">,<cfqueryparam value="#GetAuthUser()#" cfsqltype="cf_sql_char">) 
					</cfquery>
                 
                 	<cfif #form.payType# eq 'Initial'>
						<cfquery name="customer">
									select savingsPlan from customers
                    ...
                    <cfquery>
							...
							VALUES (<cfqueryparam value="#form.paymentId#" cfsqltype="cf_sql_char">, <cfqueryparam value="#lsDateFormat(CreateODBCDate(form.paydate), "dd/mm/yyyy")#" cfsqltype="cf_sql_date">,<cfqueryparam value="#trim(form.customerId)#" cfsqltype="cf_sql_char">,<cfqueryparam value="Commission" cfsqltype="cf_sql_char">, <cfqueryparam value="#trim(customer.savingsPlan)#" cfsqltype="cf_sql_double">,<cfqueryparam value="#form.accountofficer#" cfsqltype="cf_sql_char">,<cfqueryparam value="#form.paydetails#" cfsqltype="cf_sql_char">,<cfqueryparam value="#lsDateFormat(CreateODBCDate(Now()), "dd/mm/yyyy")#" cfsqltype="cf_sql_date">,<cfqueryparam value="#GetAuthUser()#" cfsqltype="cf_sql_char">) 
					</cfquery>
										</cfif>
                   ...
                   <cfcatch type="Database"> 
                    ...
                    deposit have been posted successfully</h2>
                    </div>
                    <cfelse>

						<h2>Deposit Details (Staff Use Only)</h2>
								...
								<div class="form-field">
									...
									<cfset newId = #id.id# + 1>
										<label for="paymentId">Teller Number <span>*</span></label>
                   					  <cfinput name="paymentId" id="paymentId" class="m-required" value="PYMT-#left(createUUID(),4)#-#newId#" required readonly>
									</div>
									<div class="form-field">
									...
									<div class="form-field">
										<label for="payDate">Payment Date <span>*</span></label>
										<cfinput name="payDate" id="payDate" class="m-required" placeholder="#lsDateFormat(CreateODBCDate(now()), "dd/mm/yyyy")#" readonly>
									</div>
									
									<div class="form-field">
										<label for="payType">Type <span>*</span></label>
										<cfselect id="payType" name="payType">
									...
									<div class="form-field">
									  ...
									  <cfinput name="amount" id="amount" class="m-required" pattern="\d*" placeholder="0" autocomplete="off">
									</div>
