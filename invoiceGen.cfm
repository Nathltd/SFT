  ...
  <table width="90%" cellpadding="2">
    <tr>
      ...
      <cfif isdefined('AddInvoice')>
       ...
       <cfelse>
       <cfinput value="#dateformat(now(),"dd/mm/yyyy")#" name="mydate" id="mydate" tabindex="2" title="Invoice Date" required="yes" message="Enter Invoice Date" autocomplete="off" style="width:100%" />
