...
<!--- Get data --->
<cfquery name="data">
SELECT customerName, cast(CustomerID as int) as CustomerID  FROM Customers
ORDER BY CustomerID
</cfquery>
<!--- And return it --->
<cfreturn data>
...
<cffunction name="getAllStaff" access="remote" returnType="string" hint="Get Accounts for Ajax SELECT">
<!--- Define variables --->
<cfset var data="">
<!--- Get data --->
<cfquery name="data">
...
<!---<cfloop query="data"> 
    <cfset mystruct[1]=firstName> 
    <cfset mystruct[2]=lastName> 
    <cfset mystruct[3]=staffid>
</cfloop>--->
...
<cfreturn InvNumber>
	...
	<!--- Get Auto Generate Invoice Number --->
<cffunction name="orderNumber" access="remote"   hint="Get Account for Ajax SELECT">
<!--- Define variables --->
<cfset var data="">
<!--- Get data --->
<cfquery name="data" maxrows="1">
...
<cfset InvNumber =ValueList(data.SalesOrderid)>
<cfif #InvNumber# is "">
<cfset #invNumber# = 1>
<cfelse>
<cfset InvNumber = #InvNumber#+1>
...
<cffunction name="getCustomersByStaff" access="remote" returnType="string" hint="Get Customers for Ajax SELECT">
<!--- Define variables --->
<cfargument name="staff" type="string">
<cfset var data="">
<!--- Get data --->
<cfquery name="data">
SELECT customerName, cast(CustomerID as int) as customerId, code  FROM Customers
WHERE accountOfficer = '#ARGUMENTS.staff#'
ORDER BY CustomerID
</cfquery>
<!--- And return it --->
<cfreturn serializeJSON(data, true)>
