...
<cfset this.name = "sft">
<cfset this.Datasource = "sft">
<!---<cfset this.ormenabled = "true" >--->
<cfset this.sessionManagement = "yes">
<cfset sessionTimeout = #CreateTimeSpan(0, 1, 20, 0)#>
<cfset request.dsn = "sft">
<!--- cfc Empty for Online Version --->
<cfset request.cfc = "">
<cfset request.bkup = "sft\">
<cfset request.db = "sft\db\">
<cfset request.shared = "sft\shared\">
<cfset request.footer = "&copy; #year(now())# SFTsavings.com&reg;. All rights reserved.">
...
SELECT CompanyName, Address, Phone, Phone2, Phone3, EmailAddress, Address2, logo
FROM Company 
</cfquery>
