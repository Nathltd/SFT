    ...
    <cfparam name="form.Update" default="">
		...
		<div id="wrapper">
							...
							<nav class="header-menu">
									<ul>
                                       ...
                                       <li>
                                        ...
                                        <li>
											<a href="payments.cfm">Payments</a>	
										</li>
										<li>
				...
				<div class="container">
                  ...
                  <cfparam name="errorCaught" default="">
                   ...
                   <cfcatch type="Database"> 
                    ...
                    <div id="formResult">
                    <h2>Congrats! <strong>#form.CustomerID2#</strong><br>
            ...
            <cfelseif isdefined (form.search)>
                    ...
                    <cfinput name="customerId" id="customerId" class="m-required" value="#newId#" required readonly>
									</div>
									
									<div class="form-field">
										<label for="customerName">Full Name <span>*</span></label>
										<cfinput name="customerName" id="customerName" class="m-required" required autocomplete="off">
									</div>
									<!-- SUBJECT FIELD : end -->
                                    <!-- SUBJECT FIELD : begin -->
									<div class="form-field">
										<label for="Address">Address </label>
										<cftextarea name="Address" id="Address" class="m-required"></cftextarea>
									</div>
									...
									<div class="form-field">
										...
										<cfselect id="accountOfficer" name="accountOfficer"  class="m-required" bind="cfc:#request.cfc#cfc.bind.getAllStaff()" display="staffid" value="staffid" bindonload="yes">
										<!---bind="cfc:#request.cfc#cfc.bind.getAllStaff()" display="staffid" value="staffid" bindonload="yes"--->
										</cfselect>
									</div>
									
									<div class="form-field">
										<label for="openDate">Registration Date <span>*</span></label>
										<cfinput name="openDate" id="openDate" class="m-required" placeholder="#lsDateFormat(CreateODBCDate(now()), "dd/mm/yyyy")#" readonly>
									</div>
                  <div class="form-field">
										<label for="phone">Phone </label>
                    <cfinput name="phone" id="phone" class="m-required" autocomplete="off" maxlength="11" pattern="\d*">
									</div>
                  ...
                  <div class="form-field">
										...
										<cfinput name="openingBalance" id="openingBalance" autocomplete="off" value="0" required  class="m-required">
									</div>								
                  ...
                  <div class="form-field">
									...
									<!-- SUBMIT BUTTON : begin -->
									<div class="form-field">
										<button class="submit-btn c-button" name="update" id="update" type="submit">Update</button>
									<!-- SUBMIT BUTTON : end -->
					...
					<div class="form-field">
										<button class="submit-btn c-button" name="search" id="search" type="submit">Search</button>
									<!-- SUBMIT BUTTON : end -->
					</cfform>
					</div>
					</div>
