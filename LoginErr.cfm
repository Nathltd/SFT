...
<html>
	<head>
        ...
        <title>New Heaven Multi-Level Marketing Company - Making Life Easier</title>
						...
						<div class="header-branding">
							<div class="branding-inner">
								...
								<div class="brading-logo">
									<a href="index.html"><img src="../images/logo.png" data-hires="images/logo.2x.png" alt="New Heaven"></a>
								</div>
								<!-- BRANDING LOGO : end -->
							...
							<div class="navigation-inner">
								...
								<nav class="header-menu">
									<ul>
                                        ...
                                        <li>
											<a href="payment.cfm">Activator</a>	
										</li>
										<li>
											<a href="withdrawals.cfm">Analysis</a>
										</li>
										<li>
											<a href="customers.cfm">Members</a>
										</li>
										<li>
                                        	<a href="newCustomer.cfm">Sign Up</a>
                                        </li>
									</ul>
								</nav>
								<!-- HEADER MENU : end -->
			...
			<div id="core">
				...
				<div class="container">
					...
					<div id="page-content">
						...
						<h3>Invalid User Credential, please try again. </h3>

						<!-- CONTACT FORM : begin -->
						<cfform class="default-form" method="post" id="form" >
							...
							<div class="row">
								...
								<div class="col-sm-8">
									...
									<div class="form-field">
										...
										<cfinput id="username" name="username" class="m-required" autocomplete="off">
									</div>
									<!-- SUBJECT FIELD : end -->
									...
									<div class="form-field">
										...
										<cfinput id="passWord" name="passWord" class="m-required" type="password" autocomplete="off">
									</div>
									<!-- MESSAGE FIELD : end -->
								...
								<div class="col-md-4">
									...
									<div class="widget text-widget">
										<div class="widget-inner">
											<h3 class="widget-title">About <strong>New Heaven</strong></h3>
											<div class="widget-content">

												<p><strong>New Heaven</strong>
												 is a registered Company, dedicated to providing solutions to easy life by reducing the stress on transaction difficulties. The company was established since 2007 and has been in operation since then. </p>
									...
									<div class="widget text-widget">
										<div class="widget-inner">
											...
											<div class="widget-content">
												...
												<p><strong>New Heaven MLM</strong><br>
												J'Bourg, S.A.</p>
									...
									<div class="widget subscribe-widget">
										<div class="widget-inner">
											...
											<div class="widget-content">
												...
												<p>Be the first to know when new services are available @ <strong>New Heaven</strong></p>
						...
						<div class="row">
							...
							<div class="col-md-6 col-md-pull-6">
								...
								<div class="footer-text">
									<p>&copy; 2016 New Heaven MLM. All Rights Reserved. | <a href="#">Terms &amp; Condtions</a> | <a href="#">Customer Complain &amp; Resolution Process</a></p>
								</div>
								<!-- FOOTER TEXT : end -->
